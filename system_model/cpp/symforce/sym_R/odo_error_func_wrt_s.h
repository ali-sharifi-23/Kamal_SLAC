...
Eigen::Matrix<Scalar, 3, 1> OdoErrorFuncWrtS(const Eigen::Matrix<Scalar, 3, 1>& t_i,
  ...
  _res(0, 0) = -t_odo(0, 0) * (_tmp6 + _tmp7) - t_odo(1, 0) * (_tmp1 - _tmp3) -
               t_odo(2, 0) * (_tmp4 + _tmp5);
  _res(1, 0) = -t_odo(0, 0) * (_tmp1 + _tmp3) - t_odo(1, 0) * (_tmp10 + _tmp7) -
               t_odo(2, 0) * (-_tmp8 + _tmp9);
  _res(2, 0) = -t_odo(0, 0) * (_tmp4 - _tmp5) - t_odo(1, 0) * (_tmp8 + _tmp9) -
